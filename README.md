...
The React browser client talks only to local FastAPI. Python is the only Nasdaq caller and caches option chains and stock quotes for 30 seconds and daily OHLCV for 24 hours. The Nasdaq-listed universe refreshes daily and fails closed when it cannot be loaded.
